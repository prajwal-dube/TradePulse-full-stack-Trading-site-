  ...
  return (
    <div className="container mt-5">
      ...
      <div className="row p-5 mb-5 mt-5">
        <h1 className="fs-4 text-center" style={{ color: "#3e3f42ff" }}>
      ...
      <div className="row p-4 mt-5 border-top fs-6 " style={{lineHeight: "1.8" }}>
         <div className="col-6" style={{color: "#333334ff"}}>
         ...
         <div className="col-6 " style={{ color: "#333334ff", textDecoration: "none" }}>
            ...
            <p>
                ...
                <a href="" style={{textDecoration: "none" }}> blog</a> or see what the media is 
                <a href="" style={{textDecoration: "none" }}> saying about us</a> or learn more about our business and product 
